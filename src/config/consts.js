...
const PARVULOS = new pathInfo("/", "La Lucha Estudiantil De Los \"Párvulos Guerrilleros\" Del Tec")
...
const EVENTOS = new pathInfo("/", "Eventos")
const CONTACTENOS = new pathInfo("/", "Contactenos")

const ACERCA_DE = new dropdowninfo(
        [
            QUIENES_SOMOS, 
            PARVULOS
        ],
